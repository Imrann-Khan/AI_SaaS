    ...
    w-full justify-center bg-[url(/gradientBackground.png)] bg-cover bg-no-repeat min-h-screen'>
        <div className='text-center mb-6'>
            ...
            max-sm:text-xs text-gray-600'>
                Transform your content with our suite of premier AI tools.
                Write articles, generate images, remove backgrounds, and enhance your workflow with our AI-powered solutions.
            </p>
        </div>
        ...
        <div className='flex items-center gap-4 mt-8 mx-auto text-gray-600'>
            <img src={assets.user_group} alt="hero" className='h-8' /> Trusted by 10k+ people
        </div>
    </div>
  )
}
