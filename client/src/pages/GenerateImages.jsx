...
const GenerateImages = () => {
      ...
      const imageStyle = ['Realistic', 'Ghibli', 'Cartoon', '3D', 'Pixel Art', 'Anime', 'Sketch']
  ...
  return (
    <div className='h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4 text-slate-700'>
      ...
      <form onSubmit={onSubmitHandler} className='w-full max-w-lg p-4 bg-white rounded-lg border border-gray-200'>
        ...
        rounded-md border border-gray-300' placeholder='Describe your image...' required></textarea>
      ...
      {/*right col */}
      <div className='w-full max-w-lg p-4 bg-white rounded-lg flex-col border border-gray-200
      min-h-96'>
        <div className='flex items-center gap-3'>
        ...
        <div className='flex-1 flex justify-center items-center'>
          <div className='text-sm flex flex-col utems-center gap-5 text-gray-400'>
